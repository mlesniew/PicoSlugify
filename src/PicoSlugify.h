...
String slugify(const char * input, const char replacement = '_', bool merge_consecutive = true);
...
bool is_slug(const char c, const char replacement = '_');
bool is_slug(const char * s, const char replacement = '_');
bool is_slug(const String & s, const char replacement = '_');
